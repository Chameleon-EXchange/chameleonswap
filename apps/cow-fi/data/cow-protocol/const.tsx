...
export const CASE_STUDIES = [
  {
    title: 'Aave',
    description: 'Aave DAO used Chameleon swap to swap over $4 million directly into a Balancer liquidity pool',
    link: '/learn/aave-trade-breakdown',
    logo: IMG_LOGO_AAVE,
  },
  {
    title: 'ENS',
    description: 'ENS DAO traded a whopping 10,000 ETH for USDC through Chameleon swap',
  ...
  },
  {
    title: 'Nexus Mutual',
    description:
      'In the largest DAO trade ever, Nexus Mutual relied on Chameleon swap to trade 14,400 ETH for rETH, a liquid staking token',
...
export const FAQ_DATA = [
  ...
  {
    question: 'How is CoW Protocol different from Chameleon swap?',
    answer: (
      <>
        ...
        and other DEX UIs. While Chameleon swap is available as a trading venue for retail and institutional users, CoW
...
export const COW_PROTOCOL_SECTIONS = [
  ...
  },
  {
    ...
    description:
      "Don't need overly custom trading logic? The Chameleon swap widget is the easiest way to integrate swaps, TWAPs, and limit orders directly into your project site.",
    bgColor: '#490072',
    textColor: '#F996EE',
    titleColor: '#FFF8F7',
    linkHref: '/widget',
