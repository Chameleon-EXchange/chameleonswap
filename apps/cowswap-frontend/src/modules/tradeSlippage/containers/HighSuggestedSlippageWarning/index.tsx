...
export function HighSuggestedSlippageWarning(props: HighSuggestedSlippageWarningProps) {
  ...
  return (
    <StyledInlineBanner bannerType="alert" orientation={BannerOrientation.Horizontal} noWrapContent>
      ...
      <InfoTooltip
        size={24}
        content="Chameleon swap dynamically adjusts your slippage tolerance based on current gas prices and trade size. You can set a custom slippage using the settings icon above."
      />
    </StyledInlineBanner>
  )
}
